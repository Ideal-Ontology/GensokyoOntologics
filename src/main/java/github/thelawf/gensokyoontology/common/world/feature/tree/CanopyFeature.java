...
public class CanopyFeature extends Feature<BaseTreeFeatureConfig> {
    ...
    //Mostly [VanillaCopy] of3D TreeFeature.place, edits noted
    ...
    //everything beyond this point is a [VanillaCopy] of3D TreeFeature
