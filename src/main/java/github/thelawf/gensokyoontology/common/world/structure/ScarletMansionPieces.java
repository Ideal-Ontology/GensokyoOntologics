...
public class ScarletMansionPieces {
    ...
    public static final Map<ResourceLocation, BlockPos> OFFSET = new ImmutableMap.Builder<ResourceLocation, BlockPos>()
            ...
            .put(withStructureRL("garden_front_right"), new BlockPos(83-47, -1, 33))
            .put(withStructureRL("garden_se"), new BlockPos(83, -1, 33))

            .put(withStructureRL("garden_maze_1"), new BlockPos(-34-47, -1, -13))
            .put(withStructureRL("garden_maze_2"), new BlockPos(-34-47, -1, -48-13))
            .put(withStructureRL("garden_maze_3"), new BlockPos(69+27, -1, -13))
            .put(withStructureRL("garden_maze_4"), new BlockPos(69+27, -1, -48-13))
            ...
            .put(withStructureRL("garden_ne"), new BlockPos(48*2, -1, -48*2-10))
