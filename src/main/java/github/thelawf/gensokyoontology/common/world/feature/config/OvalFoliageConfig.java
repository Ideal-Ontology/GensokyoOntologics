...
public class OvalFoliageConfig implements IFeatureConfig {
    ...
    public static final Codec<OvalFoliageConfig> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(
            ...
            ).apply(instance, OvalFoliageConfig::new));

    public OvalFoliageConfig(BlockStateProvider trunkProvider, BlockStateProvider foliageProvider, int ovalLength, int ovalWidth, int height) {
    ...
    public static class Builder {
        ...
        public OvalFoliageConfig build() {
            return new OvalFoliageConfig(this.trunkProvider, this.foliageProvider,
