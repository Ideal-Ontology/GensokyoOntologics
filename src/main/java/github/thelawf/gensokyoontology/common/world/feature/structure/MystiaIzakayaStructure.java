...
public class MystiaIzakayaStructure extends Structure<NoFeatureConfig> {
    ...
    public MystiaIzakayaStructure(Codec<NoFeatureConfig> codec) {
        super(codec);
    }
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return MystiaIzakayaStructure.Start::new;
    }
    ...
    protected boolean func_230363_a_(@NotNull ChunkGenerator chunkGenerator, @NotNull BiomeProvider provider,
        ...
        return super.func_230363_a_(chunkGenerator, provider, seed, chunkRandom, chunkX, chunkZ, biome, chunkPos, config);
    }
