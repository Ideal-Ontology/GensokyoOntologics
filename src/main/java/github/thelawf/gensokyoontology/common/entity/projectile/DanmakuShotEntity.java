...
public class DanmakuShotEntity extends AbstractDanmakuEntity implements IRendersAsItem{
    ...
    public DanmakuShotEntity(LivingEntity throwerIn, World world, DanmakuType danmakuType) {
        super(DANMAKU, throwerIn, world, danmakuType);
