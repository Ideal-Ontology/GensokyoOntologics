...
public class RemiliaScarletEntity extends YoukaiEntity implements ISpellCardUser {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new YoukaiSkillGoal<>(this, RemiliaBattle.THOUSAND_KNIVES, 1, 1, 8000));
        this.goalSelector.addGoal(3, new YoukaiTargetGoal<>(this, RemiliaBattle.CROSS_SHOTS, 1, 2, 1000));
        this.goalSelector.addGoal(3, new YoukaiSkillGoal<>(this, BossBattle.BLANK_PHASE, 1, 3, 100));
        this.goalSelector.addGoal(3, new YoukaiSkillGoal<>(this, RemiliaBattle.PETTY_DEVIL_LORD, 2, 1, 1000));
        this.goalSelector.addGoal(3, new YoukaiTimerGoal<>(this, RemiliaBattle.SPEAR_GUNGNIR, 2, 2, 800));

        this.goalSelector.addGoal(3, new YoukaiSkillGoal<>(this, FlandreBattle.FLANDRE_SPHERE, 2, 3, 800));
        this.goalSelector.addGoal(3, new YoukaiSkillGoal<>(this, BossBattle.BLANK_PHASE, 2, 4, 100));
        this.goalSelector.addGoal(3, new YoukaiSkillGoal<>(this, RemiliaBattle.VAMPIRE_SQUARE, 2, 4, 100));
