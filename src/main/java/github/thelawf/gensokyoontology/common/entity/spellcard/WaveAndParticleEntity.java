...
public class WaveAndParticleEntity extends SpellCardEntity{
    ...
    public void tick() {
        ...
        for (int i = 0; i < 3; i++) {
            SmallShotEntity smallShot = new SmallShotEntity((LivingEntity) this.getOwner(), world, DanmakuType.LARGE_SHOT, DanmakuColor.PURPLE);
            ...
            initDanmaku(smallShot, this.getPositionVec());
            smallShot.shoot(shootAngle.getX(), 0, shootAngle.getZ(), 0.6f, 0f);
