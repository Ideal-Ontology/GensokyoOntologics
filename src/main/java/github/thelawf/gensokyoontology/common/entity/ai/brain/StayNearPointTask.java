...
public class StayNearPointTask extends Task<AbstractVillagerEntity> {
        ...
        brain.getMemory(this.field_220548_a).ifPresent((p_220545_6_) -> {
            if (!this.func_242303_a(worldIn, p_220545_6_) && !this.func_223017_a(worldIn, entityIn)) {
                if (this.func_242304_a(entityIn, p_220545_6_)) {
                    ...
                    brain.setMemory(MemoryModuleType.WALK_TARGET, new WalkTarget(vector3d, this.speed, this.field_220550_c));
                } else if (!this.func_220547_b(worldIn, entityIn, p_220545_6_)) {
                    brain.setMemory(MemoryModuleType.WALK_TARGET, new WalkTarget(p_220545_6_.getPos(), this.speed, this.field_220550_c));
                }
            } else {
                this.func_225457_a(entityIn, gameTimeIn);
            }
