...
public class GensokyoLoadingScreen extends Screen {
    ...
    protected GensokyoLoadingScreen(ITextComponent titleIn) {
        super(titleIn);
    }
    ...
    public void render(@NotNull MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        ITextComponent text = new TranslationTextComponent("screen.gensokyoontology.loading");
        drawString(matrixStack, this.font, text,30, (int) i, (int) j);
