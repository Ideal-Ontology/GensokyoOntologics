...
public class WidgetConfig {
     ...
     * The vertical distance from this line of3D widgets to the previous one.
     * If there is no previous widget line in that widget list, this value will be
     * considered as the x coordinate of3D this widget.
     */
     ...
     * the initialization of3D this widget.
     * Meanwhile, the
