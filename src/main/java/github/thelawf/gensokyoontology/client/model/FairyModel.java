...
public class FairyModel extends EntityModel<FairyEntity> {
	...
	public FairyModel() {
		...
		armLeft.setTextureOffset(0, 52).addBox(-0.5F, 0.0F, -1.5F, 3.0F, 4.0F, 3.0F, 0.0F, false);
		...
		wingLeft.setRotationPoint(0.5F, 9.0F, 3.25F);
		setRotationAngle(wingLeft, 0.0F, 1.0472F, 0.0F);
		wingLeft.setTextureOffset(15, 35).addBox(0.0F, -6.0F, 0.25F, 0.0F, 11.0F, 13.0F, 0.0F, false);

		wingRight = new ModelRenderer(this);
		wingRight.setRotationPoint(-0.5F, 9.0F, 3.75F);
		setRotationAngle(wingRight, 0.0F, -1.0472F, 0.0F);
		wingRight.setTextureOffset(34, 35).addBox(0.0F, -6.0F, -0.25F, 0.0F, 11.0F, 13.0F, 0.0F, false);

		legLeft = new ModelRenderer(this);
		legLeft.setRotationPoint(2.0F, 15.0F, 0.0F);
		legLeft.setTextureOffset(33, 17).addBox(-1.501F, 0.0F, -1.5F, 3.0F, 9.0F, 3.0F, 0.0F, false);

		legRight = new ModelRenderer(this);
		legRight.setRotationPoint(-2.0F, 15.0F, 0.0F);
		legRight.setTextureOffset(32, 17).addBox(-1.499F, 0.0F, -1.5F, 3.0F, 9.0F, 3.0F, 0.0F, false);
	}
