...
public class GoheiModeSelectScreen extends MultiSelectScreen{
    ...
    public static final ITextComponent DANMAKU = GensokyoOntology.withTranslation("gui.", "gohei.mode.danmaku");
    public static final ITextComponent DREAM_SEAL = GensokyoOntology.withTranslation("gui.", "gohei.mode.dream_seal");
    ...
    protected void init() {
        super.init();
        this.guiLeft = (this.width - 32) / 2;
        this.guiTop = (this.height - 32) / 2;
    ...
    public void render(@NotNull MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        this.blit(matrixStack, this.guiLeft + 10, this.guiTop, 32, 0, 32, 32);

        this.font.drawTextWithShadow(matrixStack, DANMAKU, this.guiLeft, this.guiTop + 42, 16777215);
        this.font.drawTextWithShadow(matrixStack, DREAM_SEAL, this.guiLeft + 10, this.guiTop + 42, 16777215);

        if (mode == HakureiGohei.Mode.DANMAKU) {
            this.blit(matrixStack, this.guiLeft, this.guiTop, 64, 0, 32, 32);
        }
        else {
            this.blit(matrixStack, this.guiLeft + 10, this.guiTop, 64, 0, 32, 32);
        }
        matrixStack.pop();
    }
