...
public class DanmakuBuilderScreen extends OneSlotContainerScreen {
    ...
    public static final ITextComponent DAN_TYPE_TEXT = GensokyoOntology.fromLocaleKey("gui.", ".danmaku_builder.button.type");
    public static final ITextComponent COLOR_TEXT = GensokyoOntology.fromLocaleKey("gui.", ".danmaku_builder.button.color");
    public static final ITextComponent NAME_TEXT = GensokyoOntology.fromLocaleKey("gui.", ".danmaku_builder.button.name");
