...
// Copy from net.tropicraft.core.common.data.TropicraftWorldgenProvider
public final class GSKOWorldgenProvider implements IDataProvider {
    private static final Gson GSON = new GsonBuilder().setPrettyPrinting().create();
    private static final Logger LOGGER = LogManager.getLogger(GSKOWorldgenProvider.class);
    ...
    public GSKOWorldgenProvider(DataGenerator dataGenerator, Consumer<Generator> generatorFunction) {
